...
function StarIcon({
    ...
    style,
    onClick }) {
    const randomId = Date.now() * Math.random() * 1000;
...
function GoldStarIcon({ randomId }) {
    ...
    return (
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
            <g clip-path="url(#clip0_4913_7387)">
                <mask id={mask1Id} style={{ maskType: 'luminance' }} maskUnits="userSpaceOnUse" x="-2" y="-2" width="24" height="24">
...
function PremiumStarIcon({ randomId }) {
    return (

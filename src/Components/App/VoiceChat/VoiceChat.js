...
// const VoiceChat = forwardRef(({ VCStream, setVCState }, ref) => {
...
//             }
//             try {
//                 VCStream.current.getTracks().forEach((track) => {
...
//         if (isMuted) {
//             VCStream.current.getAudioTracks()[0].enabled = true;
//             setIsMuted(false)
//         } else {
//             VCStream.current.getAudioTracks()[0].enabled = false;
//             setIsMuted(true)
//         }
...
//         if (!hasWebcam) return
//         if (isVideoDisabled) {
//             VCStream.current.getVideoTracks()[0].enabled = true
//             peerConn.current.send('video enabled')
//             setIsVideoDisabled(false)
//         } else {
//             VCStream.current.getVideoTracks()[0].enabled = false
...
//         let videoTrack = VCStream.current.getVideoTracks()[0]
...
//                         </div>
//                         <Profile name={ui.call?.firstname} size={116} />
